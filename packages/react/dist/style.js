...
export const useStyles = createUseStyles({
    ...
    button: {
        ...
        "&:focus-visible": {
            boxShadow: "rgb(255, 255, 255) 0px 0px 0px 2px, rgb(148, 163, 184) 0px 0px 0px 4px, rgba(0, 0, 0, 0) 0px 0px 0px 0px",
    ...
    issueIcon: {
        ...
        boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(190, 24, 93, 0.8) 0px 0px 8px 0px",
    },
    ideaIcon: {
        backgroundColor: "rgb(15, 118, 110)",
        boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(15, 118, 110, 0.8) 0px 0px 8px 0px",
    },
    otherIcon: {
        backgroundColor: "rgb(14, 116, 144)",
        boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(14, 116, 144, 0.8) 0px 0px 8px 0px",
    },
    feedbackIcon: {
        pointerEvents: "none",
        width: "1rem",
    ...
    form: {
        ...
        "&> input[type='email']:focus-visible, &>textarea:focus-visible": {
            outline: "2px solid transparent",
            outlineOffset: "2px",
            boxShadow: "rgb(255, 255, 255) 0px 0px 0px 2px, var(--widget-color) 0px 0px 0px 4px, rgba(0, 0, 0, 0) 0px 0px 0px 0px",
        },
        "&> textarea": {
            display: "flex",
            height: "100%",
            ...
            "&> div": {
                ...
                "& > div": {
                    ...
                    "& > button:focus-visible": {
                        outline: "2px solid transparent",
                        outlineOffset: "2px",
                        boxShadow: "rgb(255, 255, 255) 0px 0px 0px 2px, rgb(161, 161, 170) 0px 0px 0px 4px, rgba(0, 0, 0, 0) 0px 0px 0px 0px",
                    },
                },
                "& > label": {
                    color: "#71717a",
